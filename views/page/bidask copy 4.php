                                            ...
                                            <div class="col-4">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-6 d-flex justify-content-end">
                                                        ...
                                                        <!-- <input type="number" value="" name="speed" id="speed" placeholder="Speed" class="form-control form-control-sm col-8" min="1" max="100" required> -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
